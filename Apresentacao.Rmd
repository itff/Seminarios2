...
* $h(t) = h_o(t)exp(\beta X_{ij}+\alpha Z_i)$;
  ...
  * $h_o(t)$ é a função de risco inicial, no tempo 0.
...
Temos, então, três tipos diferentes efeitos: \(\alpha\), \(\beta\) e \(\gamma\), sendo que podemos juntar os três: $\beta\gamma + \alpha$, para obter o efeito geral do tratamento. 

Nosso principal objetivo inferencial é estimar esses parâmetros, porque ele nos da informações importantes para a análise.
